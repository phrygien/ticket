...
new class extends Component {
    ...
    // Nouvelles propriétés pour le filtre de partition
    public string $partitionMonth = 'all';
    public string $partitionYear = 'all';
    ...
    public function mount(): void
    {
        ...
        $this->partitionMonth = 'all';
        $this->partitionYear = 'all';
    ...
    // Nouvelles méthodes pour le filtre de partition
    public function updatedPartitionMonth(): void
    {
        $this->loadTicketPartition();
    }

    public function updatedPartitionYear(): void
    {
        $this->loadTicketPartition();
    }
        ...
        <x-card subtitle="Classification par catégorie" separator>
            ...
            <div class="mb-6 grid grid-cols-1 md:grid-cols-4 gap-4 p-4 bg-base-200 rounded-lg">
                ...
                <div class="flex items-end">
                    <x-button class="w-full" label="Réinitialiser" wire:click="resetFilter" icon="o-arrow-path" />
                </div>
            </div>

            <x-button class="btn btn-soft btn-accent float-right mb-3" label="Mode Tableau" @click="$wire.myModal1 = true" />

            <div wire:loading wire:target="partitionMonth,partitionYear,project_id" class="flex items-center justify-center py-4">
                <div class="animate-spin rounded-full h-6 w-6 border-b-2 border-blue-500"></div>
                <span class="ml-2 text-sm text-gray-500">Mise à jour en cours...</span>
            </div>

            <div wire:ignore wire:loading.remove wire:target="partitionMonth,partitionYear,project_id" class="w-full">
