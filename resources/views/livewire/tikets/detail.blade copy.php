...
<div class="w-full mx-auto p-4">
    ...
    <x-header title="Détail du ticket #{{ $ticketId }}" subtitle="Informations complètes" separator>
        ...
        <x-slot:actions>
        <button @click="$wire.myModal1 = true" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Repondre</button>
        <button class="text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700">Repondre tous</button>
    </x-slot:actions>
    </x-header>
...
<!-- End Timeline -->
    ...
    <x-card subtitle="Historique conversation" class="mt-2">
...
@endphp
            ...
            @foreach($messages as $message)
                <article class="p-6 mb-3 text-base bg-white rounded-lg dark:bg-gray-900 
                        ...
                        <div class="flex items-center">
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-400">
                                <time datetime="{{ $message['date'] }}">
                                    {{ \Carbon\Carbon::parse($message['date'])->format('M j, Y H:i') }}
                                </time>
                            </p>
                        </div>
                        <button class="inline-flex items-center p-2 text-sm font-medium text-center text-gray-500 dark:text-gray-400 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700">
                    ...
                    {{-- Affiche seulement 2 phrases du message --}}
                    <p class="text-gray-500 dark:text-gray-400">
                        @php
                            $sentences = preg_split('/(?<=[.?!])\s+/', strip_tags($message['message']));
                            echo implode(' ', array_slice($sentences, 0, 2));
                        @endphp
                    </p>
